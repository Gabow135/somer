...
metadata:
  { "somer": { "emoji": "🧵", "os": ["darwin", "linux"], "requires": { "bins": ["tmux"] } } }
---
...
```
ACCIÓN — tmux | Comando enviado | 26/Mar/2026

RESULTADO
  Estado:     Completado
  Detalle:    Keystrokes enviados a sesión "dev" pane 0

SALIDA
  Sesión: dev | Ventana: 0 | Pane: 0
  Últimas 5 líneas:
  $ npm run build
  > somer@2.0.0 build
  > tsc && vite build
