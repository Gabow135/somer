...
metadata: { "somer": { "emoji": "🎮", "requires": { "config": ["channels.discord.token"] } } }
...
```
MENSAJE — Discord | Enviado | 26/Mar/2026

RESULTADO
  Destino:    #devops-alerts
  Tipo:       Texto con embed
  Estado:     Enviado
  Contenido:  Alerta de monitoreo — api.example.com respondiendo lento
