...
**Usar plantilla `TPL-SOCIAL`** de `_templates/RESPONSE_FORMATS.md`. Ejemplo:

```
SOCIAL — X/Twitter | Publicado | 26/Mar/2026

RESULTADO
  Acción:     Publicado
  Contenido:  "Nueva versión de SOMER 2.0 disponible..."
  URL:        x.com/usuario/status/123456
