...
- Replying in current conversation → just reply normally (SOMER routes automatically)
...
```
MENSAJE — iMessage | Enviado | 26/Mar/2026

RESULTADO
  Destino:    +52 555 1234
  Tipo:       Texto
  Estado:     Enviado
  Contenido:  Nos vemos a las 3pm en la oficina
...
Ejemplo lectura:
```
MENSAJE — iMessage | Conversación | 26/Mar/2026

CONVERSACIÓN: María García — últimos 3 mensajes
  [14:00] María: ¿A qué hora es la reunión?
  [14:05] Tú: A las 3pm en la oficina
  [14:06] María: Perfecto, ahí nos vemos
