...
When invoking this skill via SOMER’s exec tool, set a higher timeout to avoid premature termination/retries (e.g., exec timeout=300).
...
```
MEDIA — Imagen generada | 26/Mar/2026

RESULTADO
  Tipo:       Imagen
  Archivo:    generated_001.png
  Formato:    PNG
  Tamaño:     1024x1024
...
---
Procesado por: SOMER Media | Herramienta: DALL-E
```
