...
REPRODUCIENDO
  ...
  Álbum:      Suite Bergamasque
  Duración:   05:00
  Dispositivo: Sonos One (Estudio)
...
Ejemplo listado:
```
DISPOSITIVO — Bocinas Sonos | 26/Mar/2026

LISTADO
  [OK] Sonos One (Estudio) — Reproduciendo | Clair de Lune
  [OK] Sonos Beam (Sala) — Pausado
  [!]  Sonos Move (Terraza) — Desconectado
