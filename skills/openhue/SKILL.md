...
**Usar plantilla `TPL-IOT`** de `_templates/RESPONSE_FORMATS.md`. Ejemplo:

```
DISPOSITIVO — Luces actualizadas | 26/Mar/2026

RESULTADO
  Dispositivo:  Sala Principal
  Tipo:         Luz
  Ubicación:    Sala
  Estado:       Encendido — 80% brillo, 3200K
  Acción:       Brillo ajustado a 80%

LISTADO
  [OK] Sala Principal — Encendido | 80%, 3200K
  [OK] Cocina — Encendido | 100%, 4000K
  [!]  Habitación — Apagado
  [OK] Estudio — Encendido | 60%, 2700K

---
Fuente: OpenHue | Bridge: Philips Hue
```
