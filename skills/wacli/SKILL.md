...
Do NOT use `wacli` for normal user chats; SOMER routes WhatsApp conversations automatically.
...
```
MENSAJE — WhatsApp | Enviado | 26/Mar/2026

RESULTADO
  Destino:    Juan Pérez
  Tipo:       Archivo
  Estado:     Enviado
  Contenido:  propuesta_acme_v2.pdf

---
Fuente: WhatsApp (wacli)
```
